...
public class EnemyAnimator : MonoBehaviour
{
    ...
    [Header("Tuning")]
    [Tooltip("Qu� tan r�pido reacciona el blend tree a cambios de direcci�n/velocidad.")]
    public float speedSmooth = 10f;

    [Header("Normalization")]
    [Tooltip("Usa moveSpeed del EnemyManager/Unit como velocidad m�xima. Recomendada.")]
    public bool normalizeToMaxSpeed = true;

    [Tooltip("Si NO hay EnemyManager/Unit, usa este fallback como velocidad m�xima (m/s).")]
    public float fallbackMaxSpeed = 3.5f;

    [Tooltip("Si tu locomotion necesita 'm�s punch', multiplica el input normalizado. Ej: 1.2")]
    ...
    void Update()
    {
        ...
        maxSpeed = Mathf.Max(0.01f, maxSpeed); // evitar divisi�n por cero
    ...
    public void OnDeath_SetupAnimator()
    {
        ...
        // Limpia triggers t�picos para que no se mezcle nada
        ...
        // (opcional) evita que tu c�digo vuelva a tocar speed
        animator.speed = 1f;
    }
